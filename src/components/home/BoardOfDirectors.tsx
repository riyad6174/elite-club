...
const BoardOfDirectors = () => {
  const directors = [
    ...
    },
    {
      ...
      role: "CLUB PRESIDENT & EXECUTIVE DIRECTOR",
      img: "/assets/founders/zakir.jpg",
      resc_id: "2023-001",
      jersey_name: "SAYEM",
      jersey_no: "10",
    },
    ...
    },
    {
      ...
      img: "/assets/founders/mizanur.jpg",
      resc_id: "2023-003",
      jersey_name: "MIZAN",
      jersey_no: "13",
    },
          ...
          {directors.map((director, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20 bg-background/70 backdrop-blur-sm px-2 py-1 text-center">
                <span className="text-primary font-headline font-black text-xl leading-none">{director.jersey_no}</span>
              </div>
