...
const Hero = () => {
  const images = ['/assets/hero-banner.PNG', '/assets/hero-banner-2.PNG'];
      ...
      <div className='container mx-auto px-6 md:px-12 relative z-10'>
        <div className='flex flex-col lg:flex-row items-center justify-between gap-16'>
          <div className='max-w-4xl space-y-6 md:space-y-10'>
            ...
            >
              ESTABLISHED 2023 • REGINA ELITES SPORTING CLUB
            </motion.span>
            ...
            >
              MORE THAN A GAME
              <br />
              <span className='kinetic-text'>A COMMUNITY</span>
            </motion.h1>
            ...
            >
              A vibrant, non-profit sporting club in Regina, Saskatchewan —
              uniting diverse cultures through the beautiful game. From weekend
              soccer matches to community celebrations, we are more than a club.
              We are family.
            </motion.p>
          </div>
          ...
          >
            ...
            <div className='p-6 md:p-12  relative z-10 w-48 h-48 md:w-94 md:h-94 flex items-center justify-center'>
              <img
                src='/assets/logo.png'
                alt='Elites Sporting Club Emblem'
