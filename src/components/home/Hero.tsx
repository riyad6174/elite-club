        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="max-w-4xl space-y-6 md:space-y-10">
              ...
              >
                ESTABLISHED 2023 • ELITES SPORTING CLUB
              </motion.span>
            ...
            >
              A vibrant, non-profit sporting club in Regina, Saskatchewan — uniting diverse cultures through the beautiful game. From weekend soccer matches to community celebrations, we are more than a club. We are family.
            </motion.p>
          </div>
